...
import forms.AtedForms.contactDetailsForm
import play.twirl.api.HtmlFormat
import views.html.contactDetails

class ContactDetailsViewTest extends ViewTestFixture{

  val backLinkUrl: Option[String] = Some("test-url")

  val view: contactDetails = app.injector.instanceOf[views.html.contactDetails]
  override val htmlContent: HtmlFormat.Appendable =
    view.apply(contactDetailsForm,mode,backLinkUrl)(fakeRequest, authContextAgent, messages, mockAppConfig)
