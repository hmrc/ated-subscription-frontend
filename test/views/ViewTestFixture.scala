...
trait ViewTestFixture extends PlaySpec
  with MockFixture
  ...
  lazy val back_link = document.select(".govuk-width-container > a.govuk-back-link").text()

  lazy val back_link_href = document.select(".govuk-width-container > a.govuk-back-link").attr("href")
