  ...
  "ErrorMessageUtils" must {
    "return 9001" when {
      "message has error number as 9001" in {
        ...
        parseErrorResp(HttpResponse.apply(502, badGatewayResponse.toString)) must be("9001")
      }
    }
    ...
    "return 10006" when {
      "message has error number as 10006" in {
        ...
        parseErrorResp(HttpResponse.apply(502, badGatewayResponse.toString)) must be("10006")
      }
    }
    ...
    intercept[SAXParseException] {
        ...
        parseErrorResp(HttpResponse.apply(502, payload.toString))
      }
    }
