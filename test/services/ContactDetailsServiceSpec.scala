  ...
  "ContactDetailsService" must {
    "saveContactDetails" must {
      "save Contact details into keystore" in {
        ...
        when(mockDataCacheConnector.saveContactDetails(ArgumentMatchers.any())(using ArgumentMatchers.any(), ArgumentMatchers.any())).thenReturn(Future.successful(Some(testContact)))
        ...
        verify(mockDataCacheConnector, times(1)).saveContactDetails(ArgumentMatchers.any())(using ArgumentMatchers.any(), ArgumentMatchers.any())
      }
    }
    "saveContactDetailsEmail" must {
      "save Contact details email into keystore" in {
        given hc: HeaderCarrier = HeaderCarrier()
        when(mockDataCacheConnector.saveContactDetailsEmail(ArgumentMatchers.any())(using ArgumentMatchers.any(), ArgumentMatchers.any())).thenReturn(Future.successful(Some(testContactEmail)))
        ...
        verify(mockDataCacheConnector, times(1)).saveContactDetailsEmail(ArgumentMatchers.any())(using ArgumentMatchers.any(), ArgumentMatchers.any())
      }
    }
    ...
    "fetchContactDetails" must {
      "return contact details, if found in keystore" in {
        ...
        verify(mockDataCacheConnector, times(1)).fetchContactDetailsForSession(using ArgumentMatchers.any(), ArgumentMatchers.any())
      }
      ...
      "return contact details email, if found in keystore" in {
        ...
        verify(mockDataCacheConnector, times(1)).fetchContactDetailsEmailForSession(using ArgumentMatchers.any(), ArgumentMatchers.any())
      }
